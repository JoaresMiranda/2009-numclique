...
<div id="notasRodape">
  <p>Subscreva o feed <a href="<?=get_permalink()?>feed" target="_blank">RSS 2.0</a> para coment&aacute;rios.</p>
...
?>
  ...
  <h2 id="comments">Coment&aacute;rios</h2>
    ...
    <div class="<?php if ( $comment->comment_author_email == get_the_author_email() ) echo 'Meus coment&aacute;rios'; else echo $oddcomment; ?>" id="comment-<?php comment_ID() ?>"> 
